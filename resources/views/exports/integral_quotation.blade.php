...
<body>
    @php
        $quotationDetails = calculateIntegralQuotation($record, $previousMonthRecord);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <td colspan="2" valign="middle" align="center" width="40"
                style="background-color: #7d2a1d; color:white; font-weight:bold">{{ $record->title }} Integral</td>
        </tr>
