...
<body>
    @php
    $quotationDetails = calculateUruguayQuotation($record, $previousRecords);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            ...
            <td align="right"> {{ number_format($quotationDetails['socialSecurity'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['socialSecurity'] / $record->exchange_rate, 2) }}</td>
        ...
        <tr>
            <td></td>
            <th>License</th>
            <td align="right">{{ number_format($quotationDetails['license'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['license'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>Vacational Salary</th>
            <td align="right">{{ number_format($quotationDetails['vacationSalary'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['vacationSalary'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>Dismissal</th>
            <td align="right">{{ number_format($quotationDetails['dismissal'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['dismissal'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
            <th style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">Total</th>
        ...
        <tr>
            ...
            <td align="right">
                {{ number_format($quotationDetails['accumulatedSalary13th'] / $record->exchange_rate, 2) }}
            </td>
        </tr>
        <tr>
            <td></td>
            <th>License</th>
            <td align="right">{{ number_format($quotationDetails['accumulatedLicense'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['accumulatedLicense'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>Vacational Salary</th>
            <td align="right">{{ number_format($quotationDetails['accumulatedVacationSalary'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['accumulatedVacationSalary'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>Dismissal</th>
            <td align="right">{{ number_format($quotationDetails['accumulatedDismissal'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['accumulatedDismissal'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
            <th style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">Total</th>
        ...
        <tr>
            <td></td>
            <th>License</th>
            <td align="right">{{ number_format($quotationDetails['balanceLicense'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['balanceLicense'] / $record->exchange_rate, 2) }}
            </td>
        </tr>
        <tr>
            <td></td>
            <th>Vacational Salary</th>
            <td align="right">{{ number_format($quotationDetails['balanceVacationSalary'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['balanceVacationSalary'] / $record->exchange_rate, 2) }}
            </td>
        </tr>
        <tr>
            <td></td>
            <th>Dismissal</th>
            <td align="right">{{ number_format($quotationDetails['balanceDismissal'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['balanceDismissal'] / $record->exchange_rate, 2) }}
            </td>
        </tr>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
