...
<body>
    @php
    $quotationDetails = calculateCostaRicaQuotation($record, $previousRecords);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>Bonus</th>
            <td align="right">{{ number_format($quotationDetails['balanceBonus'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['balanceBonus'] / $record->exchange_rate, 2) }}
            </td>
        </tr>
        <tr>
            <td></td>
