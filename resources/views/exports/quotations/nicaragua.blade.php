...
<body>
    @php
    $quotationDetails = calculateNicaraguaQuotation($record, $previousMonthRecord);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>INSS Patronal</th>
            <td align="right"> {{ number_format($quotationDetails['inssPatronal'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['inssPatronal'] / $record->exchange_rate, 2) }}</td>

        </tr>
        <tr>
            <td></td>
            <th>INATEC</th>
            <td align="right"> {{ number_format($quotationDetails['inatec'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['inatec'] / $record->exchange_rate, 2) }}</td>
        ...
        <tr>
            ...
            <td align="right">
                {{ number_format($quotationDetails['compensation'] / $record->exchange_rate, 2) }}</td>
