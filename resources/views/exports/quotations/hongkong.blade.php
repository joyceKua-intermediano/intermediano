...
<body>
    @php
    $quotationDetails = calculateHongkongQuotation($record, $previousRecords);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>Leave</th>
            <td align="right">{{ number_format($quotationDetails['balanceLeave'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['balanceLeave'] / $record->exchange_rate, 2) }}
            </td>
        </tr>
