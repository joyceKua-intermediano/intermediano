...
<body>
    @php
    $quotationDetails = calculateElSalvadorQuotation($record, $previousMonthRecord);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>INSAFORP</th>
            <td align="right"> {{ number_format($quotationDetails['insaforp'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['insaforp'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>AFP</th>
            <td align="right"> {{ number_format($quotationDetails['afp'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['afp'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <td></td>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
