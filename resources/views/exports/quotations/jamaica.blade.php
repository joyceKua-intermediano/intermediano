...
<body>
    @php
    $quotationDetails = calculateJamaicaQuotation($record, $previousMonthRecord);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>Employer NIS</th>
            <td align="right"> {{ number_format($quotationDetails['employerNis'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['employerNis'] / $record->exchange_rate, 2) }}</td>

        </tr>
        <tr>
            <td></td>
            <th>National Housing Tax Employer</th>
            <td align="right"> {{ number_format($quotationDetails['housingTaxEmployer'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['housingTaxEmployer'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>Education Tax  Employer</th>
            <td align="right"> {{ number_format($quotationDetails['educationTaxEmployer'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['educationTaxEmployer'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>EmployerHeart Tax</th>
            <td align="right"> {{ number_format($quotationDetails['employerHeartTax'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['employerHeartTax'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <td></td>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
        ...
        <tr>
            <td></td>
            <th>Redundancy</th>
            <td align="right"> {{ number_format($quotationDetails['redundancy'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['redundancy'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
            <th style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">Total</th>
        ...
        <tr>
            <td></td>
            <th>Redundancy</th>
            <td align="right"> {{ number_format($quotationDetails['accumulatedRedundancy'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['accumulatedRedundancy'] / $record->exchange_rate, 2) }}
            </td>
