...
<body>
    @php
    $quotationDetails = calculateGuatemalaQuotation($record, $previousMonthRecord);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>IRTRA</th>
            <td align="right"> {{ number_format($quotationDetails['irtra'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['irtra'] / $record->exchange_rate, 2) }}</td>

        </tr>
        <tr>
            <td></td>
            <th>INTECAP</th>
            <td align="right"> {{ number_format($quotationDetails['intecap'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['intecap'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <th>IGSS</th>
            <td align="right"> {{ number_format($quotationDetails['igss'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['igss'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <td></td>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
        ...
        <tr>
            <td></td>
            <th>Annual Bonus</th>
            <td align="right">{{ number_format($quotationDetails['annualBonus'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['annualBonus'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            <td></td>
            <th>Indemnity</th>
            <td align="right"> {{ number_format($quotationDetails['indemnity'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['indemnity'] / $record->exchange_rate, 2) }}</td>
        </tr>
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
            <td></td>
            <th style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">Total</th>
        ...
        <tr>
            <td></td>
            <th>Annual Bonus</th>
            <td align="right">{{ number_format($quotationDetails['accumulatedAnnualBonus'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['accumulatedAnnualBonus'] / $record->exchange_rate, 2) }}
            </td>
        ...
        <tr>
            <td></td>
            <th>Indemnity</th>
            <td align="right"> {{ number_format($quotationDetails['accumulatedIndemnity'], 2) }}</td>
            <td align="right">
                {{ number_format($quotationDetails['accumulatedIndemnity'] / $record->exchange_rate, 2) }}
            </td>
