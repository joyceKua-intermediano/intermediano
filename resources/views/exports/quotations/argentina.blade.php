...
<body>
    @php
    $quotationDetails = calculateArgentinaQuotation($record, $previousMonthRecord);
    @endphp
    ...
    <table style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: red">
        ...
        <tr>
            <td></td>
            <th>National Holiday Plus </th>
            <td align="right">{{ number_format($quotationDetails['nationalHolidayplus'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['nationalHolidayplus'] / $record->exchange_rate, 2) }}</td>
        ...
        <tr style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8 ">
            <td></td>
            <th style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">Gross Payroll + PR Costs and Provisions</th>
            <td align="right" style="border: 2px solid rgb(0, 0, 0); font-weight: bold; background-color: #a8a8a8">
        ...
        <tr>
            <td></td>
            <th>Bank Fee 1,25%</th>
            <td align="right">{{ number_format($quotationDetails['bankFeePercentage'], 2) }}</td>
            <td align="right">{{ number_format($quotationDetails['bankFeePercentage'] / $record->exchange_rate, 2) }}</td>

        </tr>
        <tr>
            <td></td>
            <th>Service Tax 1,5%</th>
        ...
        <tr>
            <td></td>
            <th>{{ strtoupper($accumulatedItem) }}</th>
