...
<body>
    ...
    <main>
        <table>
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;" colspan="2">
                    <p><b>WORK CONTRACT - INDEFINITE TERM</b> <br> (Ordinary Salary)</p>
                    </th>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>Entre quienes suscriben a saber: <b>JENNIFFER KATHERINE CASANOVA OSPINA</b>, quien obra en nombre y representación de la compañía <b>INTERMEDIANO COLOMBIA S.A.S.</b>, quien obra para los efectos del presente contrato se denominara el "<b>Empleador</b>" de una parte, y de la otra {{ $employeeName }}, igualmente mayor de edad, de nacionalidad {{ $employeeLocality }}, identificado/a como aparece al pie de su firma quien obra en su propio nombre y quien para los efectos del presente contrato se denominara "<b>Empleado</b>", hemos convenido en suscribir el presente contrato individual de trabajo, a término indefinido de un año que se menciona a continuación, contrato regulado de manera general por las normas laborales y contenido de manera especial en las siguientes clausulas:</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p>Among those who subscribe to: <b>JENNIFFER KATHERINE CASANOVA OSPINA</b>, who works in the name and representation of the company <b>INTERMEDIANO COLOMBIA S.A.S.</b>, who works for the purposes of this contract will be called the "<b>Employer</b>" of one party, and the other, {{ $employeeName }}, also of legal age, of {{ $employeeNationality }} nationality, identified as it appears at the foot of his signature who works in his own name and who for the purposes of this contract will be called "<b>Employee</b>", we have agreed to subscribe the present individual contract of work, to a indefinite term of one year, mentioned below, a contract generally regulated by labor standards and contained in a special way in the following clauses:</p>
                </td>
            </tr>
        </table>
        @include('pdf.contract.layout.footer')
    ...
    <main>
        <table style="margin-top: 0px !important">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>PRIMERA. - OBJETO, FECHA DE INICIACION DE LABORES DURACION.</b> Las partes acuerdan que la duración del presente contrato será a término indefinido y su fecha de inicio será a partir de {{ $employeeStartDate }}, fecha de término indefinido.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>FIRST. - PURPOSE, DATE OF COMMENCEMENT AND DURATION.</b> The parties agree that the duration of this contract will be for an indefinite term and its starting date will be from {{ $employeeStartDate }}, indefinite end date.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>SEGUNDA. - SEDE DE TRABAJO.</b> El Empleado tendrá sede principal de trabajo en la ciudad de Cartagena. Sin embargo, conforme a las funciones propias del cargo {{ $employeeJobTitle }}, el Empleado tendrá que viajar dentro y/o fuera del territorio colombiano.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>SECOND. - PLACE OF WORK.</b> The Employee will have main headquarters of work in the city of Cartagena. However, according to the functions of the position of {{ $employeeJobTitle }}, the Employee will have to travel within and / or outside the Colombian territory.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>TERCERA. - REMUNERACION. SALARIO ORDINARIO.</b> El Empleador pagará al empleado, por la prestación de sus servicios personales, bajo la modalidad de salario ordinario mensual, la suma de {{ strtoupper($formatterLocal->format($employeeGrossSalary)) }} Moneda Colombiana (<b>COP</b> {{ number_format($employeeGrossSalary, 2) }} M/Cte.)</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>THIRD. - REMUNERATION. ORDINARY SALARY.</b> The employer shall pay the employee for the provision of their personal services, under the ordinary monthly salary mode, the sum of {{ strtoupper($formatter->format($employeeGrossSalary)) }} Colombian Currency (<b>COP</b> {{ number_format($employeeGrossSalary, 2) }} M/Cte.)</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>PARAGRAFO PRIMERO:</b> Este salario además de retribuir el trabajo ordinario, comprende el pago de prestaciones, recargos y beneficios tales como los concernientes al trabajo nocturno, extraordinario o de horas extras, en días de descanso obligatorio, sobresueldos, descansos dominicales y festivos.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>FIRST PARAGRAPH:</b> The above-mentioned salary comprises the payment of allowances, surcharges and benefits, such as those regarding night work, overtime, on mandatory rest days, premiums, work on Sundays and official and public holidays.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>PARAGRAFO SEGUNDO:</b> Cuando por causa emanada directa indirectamente de la relación contractual existan obligaciones de tipo económico a cargo del Empleado y a favor del Empleador, este último procederá a efectuar las deducciones a que hubiere lugar en cualquier tiempo y, más concretamente, a la terminación del presente contrato, </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>SECOND PARAGRAPH:</b> lf due to causes directly or indirectly originated in the contractual relationship there are economical obligations to be met by the Employee and in favor of the Employer, the latter will deduct the respective amounts at any time, and even specially, upon termination of the present contract, </p>
                </td>
            </tr>
        </table>
        @include('pdf.contract.layout.footer')
    ...
    <main>
        <table>
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <p>so The Employee now authorizes, the parties expressly understanding that this authorization meets the conditions, of a prior written order, applicable in each case. The parties expressly understood that this authorization meets the conditions prior written order, applicable to each case.</p>
                </td>
            </tr>

            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>CUARTA. - PERIODO Y FORMA DE PAGO.</b> El salario acordado en la cláusula tercera será pagado en Colombia, mensualmente en pesos colombianos (COP) mediante transferencia electrónica a la cuenta bancaria de la cual es titular el empleado.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>FOURTH. - PAYMENT PERIOD AND METHOD.</b> The salary agreed upon in clause three shall be paid in Colombia, monthly on, in Colombian pesos (COP) via electronic transfer to the bank account held by the employee.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
        ...
        <table>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>3) Guardar la reserva que requieren los asuntos relacionados con su trabajo, en razón de su naturaleza o en virtud de instrucciones especiales, aún después de haber terminado el contrato, sin perjuicio de denunciar cualquier hecho delictuoso que perjudique al Empleador;</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <p><b>SIXTH. - EMPLOYEE’S OBLIGATIONS.</b> Notwithstanding the obligations established by law, lnternal Regulations or the Employer, the' Employee especially undertakes to:</p>
                    ...
                    <p>6) To have decorum and correctness of his behavior, respect for his superiors, peers and subordinates;</p>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>en general cualquier estudio técnico o de campo relacionado directa o indirectamente con el Empleador, la creación de bases de datos de acuerdo a las características y perfiles del Empleado. El Empleado autoriza de manera previa, expresa e informada al Empleador para que, directamente o a través de sus empleados, consultores asesores y/o terceros en Colombia o en el Exterior realice Tratamiento de Datos Personales, incluido el dato biométrico, la videograbación de imagen obtenidos a través de procesos de video de vigilancia y registro de huella digital, y cualquier otro dato personal sensible. El Empleado conoce el carácter facultativo de entregar o no sus datos personales de carácter sensibles. El empleado autoriza de manera previa, expresa e informada para que el Empleador continúe sometiendo a tratamiento los Datos personales que hubieran recolectado o de cualquier forma sometido a tratamiento con anterioridad al presente contrato. Así mismo, el empleado autoriza de
                        ...
                        adecuados de protección de Datos Personales. Previa solicitud de Empleado mediante el procedimiento apropiado, el Empleador le suministrara Ia información completa de los terceros que Ilevan a cabo el tratamiento de sus Datos Personales.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p> El Empleado reconoce y acepta que el tratamiento de sus Datos Personales efectuados por fuera del territorio colombiano puede regirse por leyes extranjeras. El Empleado reconoce que ha sido informado de los derechos que le asisten en su calidad de titular de Datos Personales, entre los que se
    ...
    <main>
        <table>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>DÉCIMA TERCERA. - TERMINACIÓN UNILATERAL - CAUSAS DE TERMINACIÓN.</b> Son justas causas para que el Empleado de por terminado unilateral e inmediatamente el presente contrato: <br> a) el incumplimiento por parte del Empleador de las obligaciones contenidas en el presente contrato; y,</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
        ...
        <table>
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>(xvi) The Employee giving or obtaining money as a loan, gift, or benefit from coworkers, clients, employees of client companies, suppliers, or persons with whom they interact in the performance of their duties, or requesting or offering money, loans, gifts, or benefits from such persons; </p>
                </td>
            </tr>
    ...
    <main>
        <table style="margin-top: -5px !important">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>DÉCIMA CUARTA. - ACUERDO TOTAL.</b> <br> El presente documento es el único acuerdo entre las partes, regula la única relación laboral que ha existido entre las partes, y sustituye y deja sin efecto cualquier otro contrato o acuerdo, verbal o escrito, que se haya suscrito o ejecutado con
                        anterioridad, en relación con cualquier tipo de vinculación de Empleado.
                    </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>FOURTEENTH. - FULL AGREEMENT.</b> <br> This document is the only agreement between the parties, it regulates the only labor relationship that has existed between the parties, and it replaces and nullifies any other contract or agreement, verbal or written, that has been previously subscribed or executed, in relation with any type of Employee relationship. </p>
                </td>
            </tr>
        </table>
        @include('pdf.contract.layout.footer')
