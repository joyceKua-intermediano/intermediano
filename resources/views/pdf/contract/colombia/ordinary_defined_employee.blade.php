...
<body>
        ...
        <table class="compact-table">
            <tr>
                <td style="width: 50%; vertical-align: top;" colspan="2">
                    <p><b>CONTRATO DE TRABAJO A TERMINO FIJO</b> <br>(Salario Ordinario)</p>
                </td>
                <td style="width: 50%; vertical-align: top;" colspan="2">
                    <p><b>WORK CONTRACT - DEFINED TERM</b> <br> (Ordinary Salary)</p>
                </td>
            </tr>
            <tr>
    ...
    <main>
        <table>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>PRIMERA. - OBJETO, FECHA DE
                        ...
                        la duración del presente contrato será a término fijo y su fecha de inicio será a partir de {{ $employeeStartDate }}, fecha de término {{ $employeeEndDate }}.
                    </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>FIRST. - PURPOSE, DATE OF COMMENCEMENT AND DURATION.</b> The parties agree that the duration of this contract will be for a defined term and its starting date will be from {{ $employeeStartDate }}, until {{ $employeeEndDate }}.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>TERCERA. - REMUNERACION. SALARIO ORDINARIO.</b>
                        El Empleador pagará al Empleado por Ia prestación de sus servicios personales, bajo Ia modalidad de
                        salario ordinario mensual, la suma de
                        {{ strtoupper($formatterLocal->format($employeeGrossSalary)) }} Moneda Colombiana (<b>COP</b> {{ number_format($employeeGrossSalary, 2) }} M/Cte.)
                    </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>THIRD. - ORDINARI REMUNERATION. SALARY.</b> The employer will pay the Employee for the provision of his personal services, under the modality of ordinary monthly salary the sum of {{ strtoupper($formatter->format($employeeGrossSalary)) }} Colombian Currency (<b>COP</b> {{ number_format($employeeGrossSalary, 2) }} M/Cte.)</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>PARAGRAFO PRIMERO:</b> Este salario
                        además de retribuir el trabajo ordinario, comprende el pago de prestaciones, recargos y beneficios tales como los concernientes al trabajo nocturno, extraordinario o de horas extras, en días de descanso obligatorio, sobresueldos, descansos dominicales y festivos.
                    </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
