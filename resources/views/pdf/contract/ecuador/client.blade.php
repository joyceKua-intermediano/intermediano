...
<body>
        ...
        <table style='margin-top: 40px !important'>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>This Payroll and HR Service Agreement (the “Agreement”) is made on {{ $currentDate }} (the “Effec-tive Date”), by and <b>INTERMEDIANO ECUADOR INTERMECU SAS</b> (the <b>“Provider”</b>), a Ecuado-rian company, RUT 0993273333001, located at Av. Francisco Orellana E12-148 and Av. 12 de Octubre, Oficina 206, Mariscal Sucre, Quito, Pichincha, Ecuador , duly represented by its legal representative; AND {{ $customerName }} (the <b>“Customer”</b>), with its principal place of business at {{ $customerCountry }} and holding of-fices at {{ $customerAddress }}, duly represented by its au-thorized representative, (each, a “Party “and together, the “Parties”).</p>
                    <p><b>WHEREAS</b> Provider provides certain payroll, tax, and human resource services globally ei-ther directly or indirectly through its local part-ners.</p>
                    <p><b>WHEREAS</b> Customer also provides certain pay-roll, tax, and human resource services globally for its clients (“Customer’s Clients”); and</p>
                    <p><b>WHEREAS</b> the Parties wish to enter into this Part-nership Agreement to enable Provider to pro-vide its services to Customer for the benefit of Customer’s Clients on the terms and condi-tions set forth herein.</p>
                    <p><b>NOW, THEREFORE,</b> in consideration of the prem-ises and the mutual covenants set forth herein, the Parties hereby agree as follows:</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <h4 style="text-align:center !important; text-decoration: underline;">CONTRATO DE PARTNERSHIP</h4>
                    <p>Este Contrato de servicios de nómina y recur-sos humanos (el "Contrato") se celebra el {{ $currentDate }} e (la "Fecha de entrada en vigencia"), por y entre <b>INTERMEDIANO ECUADOR INTER-MECU SAS</b> (el <b>“Proveedor”</b>), una empresa de Ecuador, RUT 0993273333001, ubicada en la Av. Francisco Orellana E12-148 y Av. 12 de Oc-tubre, Oficina 206, Mariscal Sucre, Quito, Pi-chincha, Ecuador, debidamente represen-tada por su representante legal; Y {{ $customerName }} (el <b>“Cliente”</b>), con sede principal en {{ $customerCountry }} y domicilio social en {{ $customerAddress }}, debidamente representados por su represen-tante autorizado, (cada uno, un “Parte” y en conjunto, las “Partes”).</p>
                    <p><b>CONSIDERANDO</b> que el Proveedor brinda cier-tos servicios de nómina, impuestos y recursos humanos a nivel mundial, ya sea directa o in-directamente a través de sus socios locales;</p>
                    ...
                    <p><b>CONSIDERANDO</b> que las Partes desean cele-brar este Contrato de asociación para permi-tir que el Proveedor brinde sus servicios al Cliente en beneficio de los Clientes del Cliente en los términos y condiciones establecidos en este documento</p>
                    <p><b>AHORA, POR LO TANTO</b>, en consideración de las premisas y los convenios mutuos estableci-dos en este documento, las Partes acuerdan lo siguiente:</p>
                </td>
            </tr>
        ...
        <table style='margin-top: 0px !important'>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p><b>Service Offerings</b> Provider shall provide to Cus-tomer the services attached hereto as Sched-ule A (the “Schedule A”) and incorporated herein (collectively, the “Services”), during the Term (defined in Section VI) subject to the terms and conditions of this Agreement.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b class="underline">I - OBJETO</b></p>
                    <p><b>Ofertas de servicios.</b> El Proveedor proporcio-nará al Cliente los servicios adjuntos al pre-sente como Anexo A (el "Anexo A") e incorpo-rados aquí (colectivamente, los "Servicios"), durante el Plazo (definido en la Sección VI) su-jeto a los términos y condiciones de este Acuerdo.</p>
                </td>
            </tr>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>Notwithstanding the other obligations under this Agreement, the Provider; hereby under-takes to:</p>
                    ...
                    <p>(c) to provide, whenever customer requests it, all reports, spreadsheets, and other infor-mation relating to the Services and the coun-try’s requirements.</p>
                    <p>(d) to comply with all global and local laws, decrees, regulations, resolutions, decisions, norms, and other provisions considered by law concerning the provision of the service and la-bor matters, in particular, but not limited to, those related to the protection of the environ-ment, exempting Customer and Customer’s Client from any responsibility resulting there-from. Therefore, the Provider declares in this Agreement that its activities and Services, used now and in the future, comply with the legislation and protection and safety stand-ards concerning sanitation and environment; and</p>
                    <p>(e) to have and maintain any needed li-censes, registrations, or the like to provide the Services outlined herein.</p>

                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b class="underline">II. - RESPONSABILIDADES DEL PROVEEDOR</b></p>
                    <p>Sin perjuicio de las demás obligaciones en vir-tud de este Contrato, el Proveedor; se com-promete a:</p>
                    <p>(a) para cumplir con los requisitos y estándares de calidad exigidos por el Cliente, el cual po-drá revisar periódicamente los Servicios pres-tados por el Proveedor;</p>
                    <p>(b) recaudar todos los impuestos relacionados con sus actividades, considerando la ley local aplicable donde se están prestando los servi-cios;</p>
                    <p>(c) proporcionar, siempre que el cliente lo so-licite, todos los informes, hojas de cálculo y otra información relacionada con los Servicios y los requisitos del país;</p>
                    <p>(d) cumplir con todas las leyes, decretos, re-glamentos, resoluciones, decisiones, normas y demás disposiciones globales y locales que considere la ley relativas a la prestación del servicio y en materia laboral, en particular, pero sin limitarse a, las relacionadas con la protección del medio ambiente, eximiendo al Cliente y al Cliente del Cliente de cualquier responsabilidad que de ello se derive. Por lo tanto, el Prestador declara en este Contrato que sus actividades y Servicios, utilizados ahora y en el futuro, cumplen con la legisla-ción y las normas de protección y seguridad en materia de saneamiento y medio am-biente; y</p>
                    <p>(e) tener y mantener las licencias, registros o similares necesarios para proporcionar los Ser-vicios descritos en este documento.</p>
        ...
        <table style='margin-top: -5px !important'>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>Notwithstanding the other obligations under this Agreement, the Customer, hereby under-takes to:</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>Sin perjuicio de las demás obligaciones en vir-tud del presente Contrato, el Cliente se com-promete a:</p>
                    <p>(a) para procesar el pago mensual al Provee-dor establecido en el Anexo B (el “Anexo B”);</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">

                    <p>(b) to abide by and require Customer’s Clients to abide by Provider’s instructions con-cerning the local labor legislation, considering where the service is being provided; and</p>
                    <p>(c) to supply the technical information re-quired for the Services to be performed.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">

                    <p>(b) cumplir y exigir a los Clientes del Cliente que cumplan las instrucciones del Proveedor con respecto a la legislación laboral local, considerando el lugar donde se presta el ser-vicio; y</p>
                    <p>(c) suministrar la información técnica reque-rida para la prestación de los Servicios.</p>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>(a) For the Services agreed herein, Cus-tomer shall pay to the Provider the amount the Parties agreed upon in writing in the format outlined in Schedule B or substantially similar thereto for each Worker or Service.</p>
                    <p>(b) INVOICE: Provider will issue a monthly invoice to the Customer up to the 10th day of the month and Customer shall pay to Provider within 10 (ten) days of receipt of the invoice of the same month the invoice was issued. The in-voice will include the Worker’s gross renumer-ation (e.g., salary, bonuses, commissions, al-lowances, etc.), any mandatory employer costs (e.g., social security contributions, other taxes etc.), and Provider’s fee.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b class='underline'>IV – PAGO Y TASAS:</b></p>
                    <p>(a) Por los Servicios acordados en el presente, el Cliente pagará al Proveedor la cantidad que las Partes acordaron por escrito en el for-mato descrito en el Anexo B o sustancial-mente similar al mismo para cada Trabajador o Servicio.</p>
                    <p>(b) FACTURA: El Proveedor emitirá una factura mensual al Cliente hasta el día 10 del mes y el Cliente deberá pagar al Proveedor dentro de los 10 (diez) días siguientes a la recepción de la factura del mismo mes en que se emitió la factura. La factura incluirá la remuneración bruta del Trabajador (p. ej., salario, bonos, co-misiones, asignaciones, etc.), cualquier costo obligatorio del empleador (p. ej., contribucio-nes a la seguridad social, otros impuestos, etc.) y la tarifa del Proveedor.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
        ...
        <table style="margin-top: -5px !important">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class='lineHeightShort'>(d) Provider agrees that it will require eve-ry Worker to agree to confidentiality terms substantially similar to those outlined herein to protect Customer’s and Customer’s Client’s Confidential Information.</p>

                    <p class='lineHeightShort'>(e) Should Provider engage vendors, it will require every such vendor to agree to confi-dentiality terms substantially similar to those outlined herein to protect Customer’s and Customer’s Client’s Confidential Information.</p>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class='lineHeightShort'>Any information containing personal data shall be handled by both Parties in accord-ance with all applicable privacy laws and regulations, including without limitation the GDPR and equivalent laws and regulations. If for the performance of the Services it is neces-sary to exchange personal data, the relevant Parties shall determine their respective posi-tions towards each other (either as controller, joint controllers or processor) and </p>
        ...
        <table style="margin-top: -5px !important">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>the subse-quent consequences and responsibilities ac-cording to the GDPR as soon as possible. For the avoidance of doubt, each Party’s position may change depending upon the circum-stances of each situation.</p>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>(a) Every document, report, data, know-how, method, operation, design, trademarks confidential information, patents and any other information pro-vided by Customer to the Provider shall be and remain exclusive property of the Customer that disclosed the information.</p>

                    <p>(b) After the termination or the expiry hereof, neither Party shall use trademarks or names that may be similar to those of the other Party and/or may somewhat be con-fused by customers and companies. Each Party undertakes to use its best efforts to avoid mistakes or improper disclosure of the trademarks and names of the other Parties by unauthorized people.</p>
                    <p>(c) Provider agrees that everything provided to it or Workers by Client’s Customer re-mains the property of Client’s Customer, and that no right, title, or interest is trans-ferred to Provider or Workers including recovery of said property; this includes company laptops, phones, credit cards, etc. Provider further agrees that all right title and interest in the work product (in-cluding but not limited to intellectual property, software, works of authorship, trade secrets, designs, data or other pro-prietary information) produced by Provider or Workers under this Agreement are the sole property of Customer’s Client. Provider further agrees to assign, or cause to be assigned from time to time, to Client’s Customer on an exclusive ba-sis all rights, title and interest in and to the work product produced by Provider or Workers under this Agreement, </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table style="margin-top: -5px !important">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>including any copyrights, patents, mask work rights or other intellectual property rights relat-ing thereto, in perpetuity or for the long-est period otherwise permitted under ap-plicable law. Provider agrees that it shall not use the work product for the benefit of any party other than Customer’s Cli-ent. Nothing in this Subsection shall apply to any copyrightable material, notes, records, drawings, designs, Innovations, improvements, developments, discover-ies and trade secrets conceived, made or discovered by Provider prior to the Effec-tive Date of this Agreement. </p>
                    <p>(d) Provider shall require each Worker as-signed to Customer’s Client to agree that, to the maximum extent permitted by law, all inventions, developments or im-provements conceived or created by such Worker while engaged in rendering services under this Agreement, that relate to work or projects for Customer’s Client, shall be the exclusive property of Cus-tomer’s Client, and to assign and transfer to Customer’s Client (or to Provider for further assignment to Customer and ulti-mately to Customer’s Client) all of Work-er’s right, title and interest in and to such inventions, developments or improve-ments and to any Letter Patents, Copy-rights and applications pertaining there-to. Provider agrees that any intellectual property created during a Worker’s en-gagement with Customer’s Client remains the property of Customer’s Client as out-lined herein, even if local law deems such work the property of the employer. At Customer’s request and direction, Pro-vider agrees to take whatever steps nec-essary including those outlined herein, as applicable, to effectuate Customer’s Cli-ent’s rights in the intellectual property produced during a Worker’s engage-ment.</p>
        ...
        <table style='margin-top: -5px'>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class='underline'>1) Each Party shall indemnify, defend, and hold the other harmless against any loss, liability, cost, or expense (including reasona-ble legal fees) related to any third party claim or action that: (i) if true, would be a breach of any condition, warranty, or representations made by the indemnifying party pursuant to this Agreement; or (ii) arises out of an unlawful act (including but not limited to discrimina-tion, retaliation, and/or harassment), negli-gent act, or omission to act by indemnifying party or, its employees, or agents under this Agreement. These indemnity obligations shall be contingent upon the Party seeking to be indemnified: (i) giving prompt written notice to the indemnifying party of any claim, de-mand, or action for which indemnity is sought; (ii) reasonably cooperating in the defense or settlement of any such claim, demand, or ac-tion; and (iii) obtaining the prior written agreement of the indemnifying party to any settlement or proposal of settlement, which agreement shall not be unreasonably with-held.</p>
                    <p class='underline'>2) During the Term, and for a period of two years following the effective date of ter-mination, the Customer will, at its own ex-pense, ensure that it maintains adequate in-surance (including cover for, without limita-tion, public liability, labor liabilities and busi-ness interruption) in respect of its potential liability for loss or damage arising under or in connection with this Agreement. </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
        ...
        <table style="margin-top: -5px !important">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>(a) consecutives delays or failure to com-ply by Customer with the payments due to the Provider remuneration or repeated non-delivery or late delivery of the Services by the Provider, only after Provider has given Cus-tomer a 2 (two)months previous notice of the potential of termination and provided Cus-tomer at least 30 (thirty) days’ notice to cure it. Exception to the previous notice period will apply in case the Worker resigns at his/her own discretion, as beyond the will of the Par-ties. </p>
                    <p>(b) if any Party breaches any term or condi-tion of this Agreement and fails to remedy to such failure within fifteen (15) days from the date of receipt of written notification from the other Party;</p>
                    <p>(c) If either Party becomes or is declared in-solvent or bankrupt, is the subject of any pro-ceedings relating to its liquidation or insolven-cy or for the appointment of a receiver, con-servator, or similar officer, or makes an as-signment for the benefit of all or substantially all of its creditors or enters into any agreement for the composition, extension, or readjust-ment of all or substantially all of its obligations, then the other party may, by giving prior writ-ten notice thereof to the non-terminating Par-ty, terminate this Agreement as of a date specified in such notice.;</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>a) return to Customer the day of termination of this Agreement, any and all equipment, promotional material, and other docu-ments which have been provided by Cus-tomer in relation to the Services agreed upon in this Agreement;</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table style="margin-top: -5px !important">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>b) respect and comply with Agreement be-fore the effective termination date; and</p>
                    <p>c) If required by Customer, Provider shall de-liver to Customer the legal offboarding documentation referred to the worker.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p><b>PROVIDER´S LOCAL PARTNER:</b> In the event Pro-vider indicates any local Partner in a State-ment of Work (“SOW”), the Customer will not communicate directly to the local partner (i.e., emails, any correspondence, phone call, and so on) at any time without Provider’s writ-ten permission. Provider will be the primary and only point of contact for the entire nego-tiation and after its expiration in order to avoid damages and losses to the Provider. This provision is valid up to a period of 5 (five) years after the expiration of the Agreement. </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>BENEFITS:</b> Customer, Provider, and Workers do not have any rights or interest in Customer’s Client’s employee benefits, pension plans, stock plans, profit sharing, 401k, or other fringe benefits that are provided to Customer’s Cli-ent’s employees by Customer’s Client. All Workers engaged by Provider for Customer shall follow local legislation and the costs shall be covered by Customer entirely. </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table style="margin-top: -5px !important">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>INDEPENDENT CONTRACTOR:</b> Parties hereby agree that Provider is not employed by Cus-tomer, and nothing in this Agreement shall be construed as creating any partnership, joint venture or other relationship between Provider and Customer or Customer’s Client. This is not a contract of employment. Provider’s relation-ship with respect to Customer is that of an independent contractor. At no time during the term of this Agreement will Provider be Cus-tomer’s agent or have any right, authority or power to enter into any commitments on be-half of Customer unless specifically authorized by an officer of Customer in writing. Nothing in this Agreement shall be deemed to create any employer-employee relationship between Customer and Provider and the parties ex-pressly agree that no joint employer relation-ship shall exist with respect to the Workers who at all times shall remain employees of Provid-er.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>NON-COMPETE:</b> Provider hereby agrees that throughout this Agreement and for one year thereafter, it will not engage directly with any of Customer’s Clients to whom it has been introduced to by Customer. The Parties under-stand and agree that this does not extend to any organizations with whom Provider is al-ready contracted to perform services or learns of from a source other than Customer.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>WARRANTY:</b> Each Party hereby represents, certifies, and warrants that: (i) it is authorized to enter into this Agreement including having any necessary licenses, registrations, or the like to perform as required herein; (ii) it has no conflicts that would prevent it from meeting its obligations under this Agreement; (iii) there are no pending or anticipated material law-suits or claims against it, its directors, or officers that would prevent it from proceeding with this Agreement; (iv) neither it, nor its directors, or officers have within the last three (3) years been convicted of or had a civil judgment rendered against them for commission of fraud, criminal offense, breach of confidential-ity, or indictment;</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        ...
        <table style="margin-top: -5px !important">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>and (v) it will use its best effort to maintain and keep Worker personal information and Confidential Information se-cure from unauthorized access or use.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>(a) Changes – Any changes or inclusions to this Agreement shall be made with the mu-tual consent of the Parties and in writing and consider any local mandatory local rule.</p>
                    <p>(b) Independence – In case any provision in this Agreement shall be invalid, illegal, or unenforceable, the validity, legality and enforceability of the remaining provisions shall not in any way be affected or im-paired thereby and such provision shall be ineffective only to the extent of such inva-lidity, illegality or unenforceability.</p>
                    <p>(c) Transfer –this Agreement may not be trans-ferred or assigned in whole or in part by ei-ther Party without the prior written consent of the other Party.</p>
                    <p>(d) Entire Agreement – This Agreement con-tains the entire agreement and under-standing among the parties hereto with respect to the subject matter hereof, and supersedes all prior and contemporane-ous agreements, understandings, in-ducements and conditions, express or implied, oral or written, of any nature whatsoever with respect to the subject matter hereof. The express terms hereof control and supersede any course of per-formance and/or usage of the trade in-consistent with any of the terms hereof.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table style="margin-top: -5px !important">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>(e) Tolerance and Absence of Waiver and Novation. The tolerance of any failure to fulfill, even if repeated, by any Party, the provisions of this Agreement does not constitute or shall not be interpreted as a waiver by the other Party or as no-vation. If any court or tribunal finds that any provision or article of this Agree-ment is null, void, or without any bind-ing effect, the rest of this Contract will remain in full force and effect as if such provision or part had not integrated this Agreement.</p>
                    <p>(f) Succession - This Agreement binds the Parties and their respective successors, particulars and universals, authorized as-signees and legal representatives.</p>
                    <p>(g) Communication between the Parties - All warnings, communications, notifications and mailing resulting from the perfor-mance of this Agreement shall be done in writing, with receipt confirmation, by mail with notice of receipt, by e-mail with no-tice of receipt or by registry at the Registry of Deeds and Documents and will only be valid when directed and delivered to the Parties at the addresses indicated be-low in accordance with the applicable law.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>Address: Av. Francisco Orellana E12-148 and Av. 12 de Octubre, Oficina 206, Mariscal Sucre, Quito, Pichincha, Ecuador</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p>A/C: <b>FERNANDO JESUS SCHREINER GUTIERREZ</b></p>
                    <p>Dirección: Av. Francisco Orellana E12-148 and Av. 12 de Octubre, Oficina 206, Mariscal Sucre, Quito, Pichincha, Ecuador</p>
                    <p>Teléfono/Fax: +1 514 907 5393</p>
                    <p>E-mail: <a href="#">sac@intermediano.com</a> </p>
                </td>
            </tr>
            <tr>
