...
<body>
    ...
    <main class="main-container">
        ...
        <p>This Payroll and HR Service Agreement (the “Agreement”) is made on <b>{{ $contractCreatedDate }}</b> (the “Effective Date”), by and between <b>INTERMEDIANO HONG KONG LIMITED</b> (the “Provider”) registered with Nº 77682459 under the address Flat A11/F. Cheung Lung Ind Bldg 10 Cheung Yee ST, Cheung Sha Wan, Hong Kong, duly represented by its authorized; AND <b>{{ $companyName }}</b> (the “Customer”) a company, located at {{ $companyAddress }}, {{ $companyCountry }}, duly represented by its legal representative.</p>
        ...
        <p><b>WHEREAS</b> services will be provided by Provider in Canada </p>
    ...
    <main class="main-container">
        ...
        <p><b>c)</b> If either party becomes or is declared insolvent or bankrupt, is the subject of any proceedings relating to its liquidation or insolvency or for the appointment of a receiver, conservator, or similar officer, or makes an assignment for the benefit of all or substantially all of its creditors or enters into any agreement for the composition, extension, or readjustment of all or substantially all of its obligations, then the other party may, by giving prior written notice thereof to the nonterminating party, terminate this Agreement as of a date specified in such notice; Upon termination of this Agreement or at its termination, Provider undertakes to: </p>
        <p><b>d)</b> return to Customer the day of termination of this Agreement, any and all equipment, promotional material, and other documents which have been provided by Customer in relation to the Services agreed upon in this Agreement; as well as any compensation defined as cash advanced, among which is: deposit or guarantee, unsatisfied provisions, etc., deducted from the expenses actually incurred. </p>
        <p><b>e)</b> respect and comply with all Service requests forwarded by Customer before the date of expiration or early termination of this Agreement; </p>
    ...
    <main class="main-container">
        ...
        <p><b>(g)</b> Communication between the Parties - All warnings, communications, notifications and mailing resulting from the performance of this Agreement shall be done in writing, with receipt confirmation, by mail with notice of receipt, by email with notice of receipt or by registry at the Registry of Deeds and Documents, and will only be valid when directed and delivered to the Parties at the addresses indicated below in accordance with the applicable law. </p>
    ...
    <main class='main-container'>
        ...
        <p>The parties elect the courts of Hong Kong, to settle any doubts and/or disputes arising out of this instrument, with the exclusion of any other jurisdiction, as privileged as it may be and the applicable law shall be of Hong Kong. </p>
        ...
        <table style="width: 100%; text-align: center; border-collapse: collapse; border: none;">
            <tr style="border: none;">
                ...
                <td style="width: 50%; vertical-align: top; border: none; text-align:center !important;">
                    ...
                    @if($signatureExists)
                    <div style="text-align: center; margin-top: 0px">
                        <img src="{{ $is_pdf ? storage_path('app/private/' . $record->signature) : asset('storage/' . $record->employee_id) }}" alt="Signature" style="height: 50px; margin-bottom: -10px;">
                    </div>
                    @else
                    <div style="text-align: center; margin-top: 0px">
                    ...
                    <div style="width: 100%; border-bottom: 1px solid black;"></div>
                    <p style="margin-top: -30px; text-align: center;"> {{ $customerName }} {{ $customerSurname }}</p>
                </td>
            </tr>
        </table>
    ...
    <main class='main-container'>
        ...
        <p>At Customer’s request, Provider will recruit, vet, and interview candidates pursuant to Customer’s Client’s requirements as communicated by Customer and following the local legislation. Provider will present such candi dates to Customer subject to final approval by Customer’s Client. </p>
    ...
    <main class='main-container'>
        ...
        <p style=""> <b>DATE OF PAYMENT(every month):</b> Payment will be processed by the last day of the worked month. For efficiency, Provider will issue payment on the last day of every month. </p>
        <p style=""><b>LOCAL PAYMENT CONDITIONS:</b> Salaries and/or any other remuneration is set at the local currency of the Country where services is provided. </p>
    ...
    <main class='main-container' style='page-break-after: avoid'>
        ...
        <p>(i) Any eventual local Government measures will be charged just in case there is any changing in the local legislation. Considering the Worker is an independent contractor there should be no additional fee. </p>
