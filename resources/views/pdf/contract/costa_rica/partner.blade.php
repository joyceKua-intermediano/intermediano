...
<body>
    ...
    <main>
        <table style='margin-top: -5px !important'>
            ...
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <p>Este Contrato de Servicios de Nómina y Recursos Humanos (el "Acuerdo") se realiza el 01 de Agosto de 2022 (la "Fecha de Vigencia"), por y entre INTERMEDIANO S.R.L., empresa de Costa Rica con cédula Jurídica No. 3-102-728410, Ubicada en la Avenidas 2 y 4, calle 5, Escazú San Jose, Costa Rica, en adelante denominado simplemente como (el <b>“Cliente”</b>); Y {{ $partnerName }} (el <b>“Proveedor”</b>), con sede principal en la {{ $partnerAddress }}, debidamente representada por su representante autorizado, (el <b>“Proveedor”</b>).</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table style='margin-top: 35px !important'>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b style='text-decoration: underline'>I. - PURPOSE</b></p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b style='text-decoration: underline'>I. FINALIDAD</b></p>
                </td>
            </tr>

            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p class='line-height-sm'><b>Service Offerings.</b> Provider shall provide to Customer the services of payroll, consulting and HR attached hereto as Schedule A (the “Schedule A”) and incorporated herein (collectively, the “Services”), during the Term (defined in Section VII) subject to the terms and conditions of this Agreement. </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>I. PROVIDER RESPONSIBILITIES</b></p>
                </td>
                <td style="width: 50%; vertical-align: top;">
    ...
    <main>
        <table style='margin-top: 0px'>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>Any information containing personal data shall be handled in accordance with all applicable privacy laws and regulations, </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p>Cualquier información que contenga datos personales se manejará de acuerdo con todas las leyes y reglamentaciones de privacidad aplicables, </p>
                </td>
            </tr>
        </table>
        @include('pdf.contract.layout.footer')
    ...
    <main>
        <table style='margin-top: 0px'>
            ...
            <tr>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <p><b>(a)</b> Cambios – Cualquier cambio o inclusión a este Acuerdo se hará con el consentimiento mutuo de las Partes y por escrito y considerará cualquier regla local obligatoria.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>(d)</b> Entire Agreement – This Agreement contains the entire agreement and understanding among the parties hereto with respect to the subject matter hereof, and supersedes all prior and</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>(d)</b> Acuerdo completo: este Acuerdo contiene el acuerdo completo y el entendimiento entre las partes con respecto al tema del presente, y reemplaza todos los acuerdos, entendimientos,</p>
                </td>
            </tr>
        </table>
        @include('pdf.contract.layout.footer')
    ...
    <main>
        <table style='margin-top: 30px'>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p> contemporaneous agreements, understandings, inducements and conditions, express or implied, oral or written, of any nature whatsoever with respect to the subject matter hereof. The express terms hereof control and supersede any course of performance and/or usage of the trade inconsistent with any of the terms hereof.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p> incentivos y condiciones anteriores y contemporáneos, expresos o implícitos, orales o escritos, de cualquier naturaleza con respecto al objeto del presente. Los términos expresos del presente controlan y reemplazan cualquier curso de rendimiento y / o uso del comercio inconsistente con cualquiera de los términos del presente documento.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
        ...
        <table style="margin-top: -5px !important">
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="line-height: 1.5; margin: 2px; margin-top: 10px;">A/C: <b>{{ $partnerContactName }}</b></p>
                    <p style="line-height: 1.5; margin: 2px;"><b>Address:</b> {{ $partnerAddress }} </p>
                    <p style="line-height: 1.5; margin: 2px;"><b>Phone/Fax:</b> {{ $partnerPhone }}</p>
                    <p style="line-height: 1.5; margin: 2px;"><b>E-mail:</b> <a href="#">{{ $partnerEmail }}</a> </p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p>Si al <b>Proveedor: </b></p>
                    <p style="line-height: 1.5; margin: 2px; margin-top: 10px;">A/C: <b>{{ $partnerContactName }} </b></p>
                    <p style="line-height: 1.5; margin: 2px;"><b>Dirección:</b> {{ $partnerAddress }} </p>
                    <p style="line-height: 1.5; margin: 2px;"><b>Telefone:</b> {{ $partnerPhone }}</p>
                    <p style="line-height: 1.5; margin: 2px;"><b>E-mail:</b> <a href="#">{{ $partnerEmail }}</a> </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>The parties elect the courts of Costa Rica – San Jose, to settle any doubts and/or disputes arising out of this instrument, with the exclusion of any other jurisdiction, as privileged as it may be and the applicable law shall be of the COSTA RICA.</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    <p>Las partes eligen a los tribunales de Costa Rica – San José, para resolver cualquier duda y / o disputa que surja de este instrumento, con la exclusión de cualquier otra jurisdicción, por privilegiada que sea y la ley aplicable será la de COSTA RICA. </p>
    ...
    <main style='page-break-after: avoid'>
        <table style='margin-top: 0px'>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="text-align: left; font-weight: bold">SERVICES</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p style="text-align: left; font-weight: bold">SERVICIOS</p>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p style="text-align: center; font-weight: bold;">ANNEX II</p>
                    <p style="text-align: center; font-weight: bold">PRICE</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p style="text-align: center; font-weight: bold;">ANEXO II</p>
                    <p style="text-align: center; font-weight: bold">PRECIO</p>
                </td>
            </tr>
        ...
        <table style='margin-top: -5px'>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>The total tax payment for the contract is the responsibility of the contractor.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p>El pago total de los impuestos correspondientes al contrato es de total responsabilidad del contratista.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>Payments to be processed within 24 hours after reception and performed monthly as approved by the customer.</p>
                    <p>Payments to be processed to the bank account informed by the contractor.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p>Pagos realizados dentro de las 24 horas después de recibido y ejecutados. mensualmente según aprobación del cliente.</p>
                    <p>Pagos para realizar a la cuenta bancaria informada por el contratista.</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <p>The <b>Customer</b> is not responsible for exchange rates fluctuations.</p>
                </td>
                <td style="width: 50%; vertical-align: top;">
                    <p><b>El Cliente</b> no es responsable por fluctuaciones cambiarias. </p>
                </td>
            </tr>
        </table>
        @include('pdf.contract.layout.footer')
