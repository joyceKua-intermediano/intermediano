    ...
    <main>
        <table>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <b>Clause 1 – Post</b>
                    <p>The EMPLOYEE undertakes to provide her services to the EMPLOYER, in the capacity of EMPLOYEE in the post of {{ $employeeJobTitle }}, her/his duties being defined in the job description attached and integrating the staff of the EMPLOYER.</p>
                    <br>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <div style="text-align: center;">
                        ...
                        <div style="text-align:center; width: 70%; border-bottom: 1px solid black; margin: 0px auto 0;"></div>
                        <b>INTERMEDIANO DO BRASIL</b> <br>
                        <b>APOIO ADMINISTRATIVO LTDA</b>

                        <div style="text-align:center; width: 70%; border-bottom: 1px solid black; margin: 90px auto 0;"></div>
                        <b>{{ $employeeName }}</b>
                    </div>
