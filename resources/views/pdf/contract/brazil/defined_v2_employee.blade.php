        ...
        <table>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class='short-lineheight'>Nothing in this Agreement shall be deemed to be the granting or assignment of a license to an EMPLOYEE by the EMPLOYER, any existing or future intellectual property right in respect of which the EMPLOYER has a right of ownership or a right of use.</p>
                    <p class='short-lineheight'>For the purposes of this Contract, the term “Intellectual Property” includes patents, rights to inventions, copyright and related rights, moral rights (to the extent permitted by law),</p>
                    <p class="short-lineheight">trademarks and service marks, trade names and domain names, rights in get-up, rights to goodwill or to sue for passing off, rights in designs, rights in computer software, database rights, rights in confidential information (including know-how and trade secrets) and any other intellectual property rights, in each case whether registered or unregistered and including all applications (or rights to apply) for, and renewals or extensions of, such rights and all similar or equivalent rights or forms of protection which subsist now or will subsist in the future in any part of the world because of what was produced, invented or discovered by the EMPLOYEE, whether alone or with any other person, at any time during his employment with the EMPLOYER which relates directly or indirectly to the business of the EMPLOYER or which may, in the reasonable opinion of the EMPLOYER, be capable of being used or adapted for use therein.</p>

                    <p class="short-lineheight">All Intellectual Property to which this section applies shall, to the fullest extent permitted by law, belong to, vest in and be the absolute, sole, exclusive and unencumbered property of the EMPLOYER.</p>

                </td>
                <td style="width: 50%; vertical-align: top;">
                    <b>Cláusula 12ª – Direito de Propriedade Intelectual</b>
                    <p class='short-lineheight'>Nada neste Contrato será interpretado como concessão ou atribuição de uma licença ao EMPREGADO pelo EMPREGADOR, referente a qualquer direito de propriedade intelectual existente ou futuro sobre o qual o EMPREGADOR detenha direito de propriedade ou de uso.</p>
                    <p class='short-lineheight'>Para os fins deste Contrato, o termo “Propriedade Intelectual” inclui patentes, direitos sobre invenções, direitos autorais e direitos conexos, direitos morais (na medida permitida por lei), </p>
                    <p class="short-lineheight">marcas registradas e marcas de serviço, nomes comerciais e nomes de domínio, direitos sobre embalagens e identidade visual, direitos sobre fundo de comércio ou para ações de concorrência desleal, direitos sobre designs, direitos sobre software, direitos sobre bancos de dados, direitos sobre informações confidenciais (incluindo know-how e segredos comerciais) e quaisquer outros direitos de propriedade intelectual, sejam registrados ou não, incluindo todas as aplicações (ou direitos de aplicação), renovações ou extensões desses direitos e todos os direitos semelhantes ou equivalentes que existam ou venham a existir no futuro em qualquer parte do mundo, em razão de criações, invenções ou descobertas feitas pelo Empregado, sozinho ou com qualquer outra pessoa, a qualquer momento durante seu emprego com o EMPREGADOR e que estejam direta ou indiretamente relacionadas aos negócios do EMPREGADOR ou que, na opinião razoável do EMPREGADOR, possam ser utilizados ou adaptados para uso nos negócios.</p>

                    <p class="short-lineheight">Toda a Propriedade Intelectual a que se aplica esta seção pertencerá, na máxima extensão permitida por lei, exclusivamente ao EMPREGADOR, sendo de sua propriedade absoluta, exclusiva e sem ônus.</p>
        ...
        <table>
            ...
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class="short-lineheight" style='text-align: center'>The EMPLOYEE hereby undertakes:</p>
                    <p class="short-lineheight">To notify and disclose to the EMPLOYER in writing full details of all Intellectual Property to which this section applies promptly upon the production, invention or discovery of same, and promptly, whenever requested by the EMPLOYER, and in any event upon the termination of employment with the EMPLOYER, to deliver up to the EMPLOYER all correspondence and other documents, papers and records and all copies thereof in the EMPLOYEE’S possession, custody or power relating to any Intellectual Property;</p>
                    <p class='short-lineheight'>To hold on trust for the benefit of the EMPLOYER any Intellectual Property to the extent that the same may not be, and until the same is, vested absolutely in the EMPLOYER.</p>
                    <p class='short-lineheight'>Assign, by way of present assignment of future copyright, all copyright in all Intellectual Property to which this section applies.</p>
                ...
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class="short-lineheight" style='text-align: center'>O EMPREGADO compromete-se a:</p>
                    <p class="short-lineheight">Notificar e divulgar ao EMPREGADOR, por escrito, todos os detalhes da Propriedade Intelectual a que se aplica esta seção, imediatamente após sua criação, invenção ou descoberta, e sempre que solicitado pelo EMPREGADOR. Além disso, no momento da rescisão do emprego, entregar ao EMPREGADOR toda a correspondência, documentos, papéis e registros relacionados à Propriedade Intelectual em sua posse, custódia ou poder.</p>
                    <p class='short-lineheight'>Manter a Propriedade Intelectual em confiança para benefício do EMPREGADOR, na medida em que a mesma não seja imediatamente transferida ou esteja em processo de ser transferida integralmente para o EMPREGADOR.</p>
                    <p class='short-lineheight'>Ceder, por meio deste contrato, todos os direitos autorais relacionados à Propriedade Intelectual abrangida por esta seção.</p>
        ...
        <table>
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    ...
                    <p class='short-lineheight'>If the EMPLOYEE does so include such Intellectual Property Rights, the EMPLOYEE hereby expressly assigns the ownership of such Intellectual Property Rights to the EMPLOYER and such material shall be deemed to have been created during the employment for the purposes
