...
<body>
    ...
    <table class="table">
        ...
        <tr class="">
            <th class="p-4 text-left">I.E.S.S. Instituto Ecuatoriano de Seguridad Social</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['iess'], 2) }}
                </span>
            </td>
        </tr>
        <tr>
            <th class="p-4 text-left">SECAP Ecuadorian Training Service</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['secap'], 2) }}
                </span>
            </td>
        </tr>
        <tr>
            <th class="p-4 text-left">IECE Ecuadorian Institute of Education and Educational</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['iece'], 2) }}
                </span>
            </td>
        </tr>
        ...
        <tr class="">
            <th class="p-4">Reserve Fund</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['reserveFund'], 2) }}
                </span>
            </td>
        </tr>

        <tr class="">
            <th class="p-4">Bonus 13th</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['bonus13th'], 2) }}
                </span>
            </td>
        </tr>

        <tr class="">
            <th class="p-4">Bonus 14th</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['bonus14th'], 2) }}
                </span>
            </td>
        </tr>

        <tr class="">
            <th class="p-4">25% Bonification</th>
            <td class="p-4 space-between">
                <span class="currencyAlignment"> {{ $record->currency_name }}</span>
                <span class="recordAlignment">
                    {{ number_format($quotationDetails['bonification'], 2) }}
                </span>
            </td>
        </tr>
