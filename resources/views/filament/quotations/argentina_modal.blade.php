...
$intermedianoCompany =preg_replace('/(?<!^)([A-Z]) /', ' $1' , $record->cluster_name);
    ...
    <div class="space-y-6 p-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 gap-6 mt-4">
            ...
            <div class="flex justify-between p-2">
                <span class="font-medium text-gray-600 w-2/5">National Holiday Plus </span>
                <div class="flex justify-between w-40">
                    <span class="mr-4">
                        {{ $record->currency_name }}
                    </span>
                    <span class="text-gray-800">{{ number_format($quotationDetails['nationalHolidayplus'], 2) }}</span>
                </div>
                <span class="text-gray-800 w-1/5 text-right">USD {{ number_format($quotationDetails['nationalHolidayplus'] / $record->exchange_rate, 2) }}</span>
            </div>
            <div class="flex justify-between p-2">
            ...
            <div class="flex justify-between p-2 bg-gray-200">
                <span class="font-medium text-gray-600 w-2/5">Gross Payroll + PR Costs & Provisions</span>
                <div class="flex justify-between w-40">
                    <span class="mr-4">
                        {{ $record->currency_name }}
                    </span>
            ...
            <div class="flex justify-between p-2">
                <span class="font-medium text-gray-600 w-2/5">Bank Fee 1,25%</span>
                <div class="flex justify-between w-40">
                    <span class="mr-4">
                        {{ $record->currency_name }}
                    </span>
                    <span class="text-gray-800">{{ number_format($quotationDetails['bankFeePercentage'], 2) }}</span>
                </div>
                <span class="text-gray-800 w-1/5 text-right">USD {{ number_format($quotationDetails['bankFeePercentage'] / $record->exchange_rate, 2) }}</span>
            </div>
            <div class="flex justify-between p-2">
                <span class="font-medium text-gray-600 w-2/5">Service Tax 1,5%</span>
                <div class="flex justify-between w-40">
                    <span class="mr-4">
                        {{ $record->currency_name }}
                    </span>
    ...
    <div class="space-y-6 p-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 gap-6 mt-4">
            ...
            <div class="flex justify-between p-2">
                <span class="font-medium text-gray-600 	w-2/5">{{ camelCaseToWords($payrollCostsItem) }}</span>
                <div class="flex justify-between w-40">
                    <span class="mr-4">
                        {{ $record->currency_name }}
                    </span>
                    <span class="text-gray-800">{{ number_format($quotationDetails[$payrollCostsItem], 2) }}</span>
                </div>
                <span class="text-gray-800 w-1/5 text-right">USD {{ number_format($quotationDetails[$payrollCostsItem] / $record->exchange_rate, 2) }}</span>
    ...
    <div class="space-y-6 p-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 gap-6 mt-4">
            ...
            <div class="flex justify-between p-2">
                <span class="font-medium text-gray-600 	w-2/5">{{ camelCaseToWords($provisionItem) }}</span>
                <div class="flex justify-between w-40">
                    <span class="mr-4">
                        {{ $record->currency_name }}
                    </span>
                    <span class="text-gray-800">{{ number_format($quotationDetails[$provisionItem], 2) }}</span>
                </div>
                <span class="text-gray-800 w-1/5 text-right">USD {{ number_format($quotationDetails[$provisionItem]  / $record->exchange_rate, 2) }}</span>
            </div>
            @endforeach
