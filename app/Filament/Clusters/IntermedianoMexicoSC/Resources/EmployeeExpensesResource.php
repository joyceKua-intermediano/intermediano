...
use App\Filament\Clusters\IntermedianoMexicoSC\Resources\EmployeeExpensesResource\Pages;
use App\Filament\Clusters\IntermedianoMexicoSC\Resources\EmployeeExpensesResource\RelationManagers;
...
class EmployeeExpensesResource extends Resource
{
                ...
                Forms\Components\Select::make('employee_id')
                    ...
                    ->options(function () {
                        ...
                        return Employee::whereHas('contract', function ($query) {
                            $query->where('cluster_name', 'IntermedianoMexicoSC');
                        })->pluck('name', 'id');
    ...
    public static function getEloquentQuery(): Builder
    {
        $contractCluster = EmployeeExpenses::whereHas('employee', function ($query) {
            $query->where('company', 'IntermedianoMexicoSC');
        });
