...
use App\Filament\Clusters\IntermedianoMexicoSC\Resources\QuotationResource\Pages;
use App\Filament\Clusters\IntermedianoMexicoSC\Resources\QuotationResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Hidden::make('country_id')
                    ->default(function () {
                        return \App\Models\Country::where('name', 'Mexico')->value('id');
                    }),
            ...
            ->actions([
                Tables\Actions\Action::make('view_quotation')
                    ...
                    ->modalContent(function ($record) {
                        // dd($record);
                        $viewModal = 'filament.quotations.mexico_modal';
