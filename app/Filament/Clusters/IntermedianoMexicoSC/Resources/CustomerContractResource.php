...
namespace App\Filament\Clusters\IntermedianoMexicoSC\Resources;

use App\Filament\Clusters\IntermedianoMexicoSC;
use App\Filament\Clusters\IntermedianoMexicoSC\Resources\CustomerContractResource\Pages;
use App\Filament\Clusters\IntermedianoMexicoSC\Resources\CustomerContractResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('employee_id')
                    ->relationship('employee', 'name', fn(Builder $query) => $query->where('company', 'IntermedianoMexicoSC'))
                    ->required(),
                Forms\Components\Select::make('quotation_id')
                    ->relationship(
                        'quotation',
                        'title',
                        fn(Builder $query) => $query->where('cluster_name', 'IntermedianoMexicoSC')->where('is_payroll', '0')
                    )
                    ->required(),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('pdf')
                    ...
                    ->action(function ($record, $data) {
                        ...
                        $footerDetails = [
                            'companyName' => 'Intermediano SA de CV',
