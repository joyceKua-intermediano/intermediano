...
use App\Filament\Clusters\IntermedianoCostaRica\Resources\CustomerContractResource\Pages;
use App\Filament\Clusters\IntermedianoCostaRica\Resources\CustomerContractResource\RelationManagers;
            ...
            ->schema([
                ...
                Forms\Components\Select::make('quotation_id')
                    ->relationship(
                        'quotation',
                        'title',
                        fn(Builder $query) => $query->where('cluster_name', 'IntermedianoCostaRica')->where('is_payroll', '0')
                    )
                    ->required(),
