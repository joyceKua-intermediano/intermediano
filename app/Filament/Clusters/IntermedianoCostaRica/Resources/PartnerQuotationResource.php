...
use App\Filament\Clusters\IntermedianoCostaRica\Resources\PartnerQuotationResource\Pages;
use App\Filament\Clusters\IntermedianoCostaRica\Resources\PartnerQuotationResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Hidden::make('country_id')
                    ->default(function () {
                        return \App\Models\Country::where('name', 'Costa Rica')->value('id');
                    }),
        ...
        return $table
            ...
            ->filters([
                ...
                Filter::make('cluster_match')
                    ->label('Company Name')
                    ->query(fn(Builder $query): Builder => $query->where('cluster_name', 'PartnerCostaRica'))
                    ->default(),
