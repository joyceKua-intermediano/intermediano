...
use App\Filament\Clusters\IntermedianoChileSPA\Resources\QuotationResource\Pages;
use App\Filament\Clusters\IntermedianoChileSPA\Resources\QuotationResource\RelationManagers;
        ...
        return $form
            ...
            JS))
                ...
                Fieldset::make('PayrollCosts')
                    ...
                    ->label('Payroll Costs')
                    ->schema([
                        TextInput::make('uf_month')->label('UF of the Month'),
                    ]),
            ...
            ->actions([
                Tables\Actions\Action::make('view_quotation')
                    ...
                    ->modalContent(function ($record) {
                        // dd($record);
                        $viewModal = 'filament.quotations.chile_modal';
