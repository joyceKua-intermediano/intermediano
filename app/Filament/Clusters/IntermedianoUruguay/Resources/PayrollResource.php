...
use App\Filament\Clusters\IntermedianoUruguay\Resources\PayrollResource\Pages;
use App\Filament\Clusters\IntermedianoUruguay\Resources\PayrollResource\RelationManagers;
            ...
            ->actions([
                Tables\Actions\Action::make('view_quotation')
                    ...
                    ->modalContent(function ($record) {
                        $viewModal = 'filament.quotations.uruguay_modal';
                ...
                ExportAction::make('export')
                    ...
                    ->action(function ($record) {
                        ...
                        $previousRecords = Quotation::where('consultant_id', $record->consultant_id)
                            ...
                            ->where('cluster_name', 'IntermedianoUruguay')
                            ->get();
