...
use App\Filament\Clusters\IntermedianoEcuadorSAS\Resources\TimesheetResource\Pages;
use App\Filament\Clusters\IntermedianoEcuadorSAS\Resources\TimesheetResource\RelationManagers;
...
class TimesheetResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        $contractCluster = MonthlyTimesheet::whereHas('employee', function ($query) {
            $query->where('company', 'IntermedianoEcuadorSAS');
        });
