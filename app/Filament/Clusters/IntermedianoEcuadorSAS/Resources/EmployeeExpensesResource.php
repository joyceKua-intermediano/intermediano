...
use App\Filament\Clusters\IntermedianoEcuadorSAS\Resources\EmployeeExpensesResource\Pages;
use App\Filament\Clusters\IntermedianoEcuadorSAS\Resources\EmployeeExpensesResource\RelationManagers;
                ...
                Forms\Components\Select::make('employee_id')
                    ...
                    ->options(function () {
                        ...
                        return Employee::whereHas('contract', function ($query) {
                            $query->where('cluster_name', 'IntermedianoPeruSAC');
                        })->pluck('name', 'id');
