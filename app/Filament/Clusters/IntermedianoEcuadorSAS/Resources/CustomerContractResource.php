...
use App\Filament\Clusters\IntermedianoEcuadorSAS\Resources\CustomerContractResource\Pages;
use App\Filament\Clusters\IntermedianoEcuadorSAS\Resources\CustomerContractResource\RelationManagers;
            ...
            ->schema([
                ...
                Forms\Components\Select::make('quotation_id')
                    ->relationship(
                        'quotation',
                        'title',
                        fn(Builder $query) => $query->where('cluster_name', 'IntermedianoEcuadorSAS')->where('is_payroll', '0')
                    )
                    ->required(),
