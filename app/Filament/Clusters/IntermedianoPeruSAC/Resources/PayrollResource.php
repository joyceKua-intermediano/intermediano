...
use App\Filament\Clusters\IntermedianoPeruSAC\Resources\PayrollResource\Pages;
use App\Filament\Clusters\IntermedianoPeruSAC\Resources\PayrollResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Hidden::make('country_id')
                    ->default(function () {
                        return \App\Models\Country::where('name', 'Peru')->value('id');
                    }),
            ...
            JS))
                ...
                Forms\Components\TextInput::make('legal_grafication')
                    ...
                    ->default(0)
                    ->required(),
                Forms\Components\TextInput::make('family_allowance')
                    ->mask(RawJs::make(<<<'JS'
                    $money($input, '.', ',', 2)
                    JS))
                    ->afterStateUpdated(function ($component, $state) {
            ...
            ->actions([
                Tables\Actions\Action::make('view_quotation')
                    ...
                    ->modalContent(function ($record) {
                        $viewModal = 'filament.quotations.peru_modal';
                ...
                ExportAction::make('export')
                    ...
                    ->action(function ($record) {
                        ...
                        $previousRecords = Quotation::where('consultant_id', $record->consultant_id)
                            ...
                            ->where('cluster_name', 'IntermedianoPeruSAC')
                            ->get();
