...
use App\Filament\Clusters\IntermedianoPeruSAC\Resources\EmployeeContractResource\Pages;
use App\Filament\Clusters\IntermedianoPeruSAC\Resources\EmployeeContractResource\RelationManagers;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('employee_id')
                    ->relationship('employee', 'name', fn(Builder $query) => $query->where('company', 'IntermedianoPeruSAC'))
                    ->required(),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('pdf')
                    ...
                    ->action(function ($record) {
                        ...
                        $footerDetails = [
                            'companyName' => 'Intermediano Perú SAC',
