...
use App\Filament\Customer\Resources\EmployeeExpensesResource\Pages;
use App\Filament\Customer\Resources\EmployeeExpensesResource\RelationManagers;
...
class EmployeeExpensesResource extends Resource
{
            ...
            ->schema([
                Forms\Components\Select::make('employee_id')
                    ...
                    ->options(function () {
                        ...
                        return Employee::whereHas('contract', function ($query) use ($customerId) {
                    ...
                    ->schema([
                        ...
                        ->default(fn(string $operation) => $operation === 'create' ? 'approved' : null)
                            ->options([
                                ...
                                'approved' => 'Approved',
                                'rejected' => 'Rejected',
                            ])->columnSpan(1)->hidden(fn($record) => $record && $record?->created_by !== 'employee' && $getUserTable === 'customers'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('employee_id')
                    ...
                    ->options(function () {
                        ...
                        return \App\Models\Employee::whereHas('contract', function ($query) use ($customerId) {
                            $query->where('company_id', $customerId);
                        })->pluck('name', 'id');
                    })
                    ->searchable(),
            ...
            ->actions([
                Tables\Actions\EditAction::make()->label('Review Expenses'),
                Tables\Actions\Action::make('quick-approve')
                    ...
                    ->visible(fn($record) => $record->created_by === 'employee' && $record->status !== 'approved')
    ...
    // protected static function canUpdate($record): bool
    // {
    //     return $record->created_by === 'customer';
    // }
}
